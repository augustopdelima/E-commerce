  ...
  return (
    <div className="p-6">
      <div className="flex justify-between items-center mb-6">
        ...
        <button
          onClick={() => navigate("/admin/suppliers/reactivate")}
          className="bg-green-600 cursor-pointer hover:bg-green-700 text-white px-4 py-2 rounded-lg transition-colors duration-200"
        >
          Reativar Fornecedor 
        </button>
      </div>
